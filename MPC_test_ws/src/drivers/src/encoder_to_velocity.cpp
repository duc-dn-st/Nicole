...
void saveSteeringAngles()
{
    ...
    fout.open("/home/musashi_03/musashi_ws/angles.csv", std::ios::out | std::ios::app); 
...
//    velocity_msgs_.header.stamp = ros::Time::now().toNSec();
    ...
    for (unsigned int i = 0; i < encoder_count_; i++)
    {
        ...
        else
        {
            ...
            double relative_angle =  (double)encoder_pulses_[i] / EncoderConstants::STEERING_MAXIMUM_PULSE * MathConstants::TWOPI + 0;
