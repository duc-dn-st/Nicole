...
namespace RobotConstants
{
    ...
    constexpr double AXLE_LENGTH                 = 0.58;             // [m]
    constexpr double ROBOT_WIDTH                 = 0.96;             // [m]
    constexpr double ROBOT_LENGTH                = 1.30;             // [m]
    constexpr double WHEEL_RADIUS                = 0.09;             // [m]
    ...
    constexpr double MAX_WHEEL_ACC               = DRIVING_RATED_TORQUE * WHEEL_RADIUS / (0.25 * ROBOT_MASS * WHEEL_RADIUS * WHEEL_RADIUS + DRIVING_INERTIA);          // [m/s^2]
    constexpr double MAX_WHEEL_VEL               = ((MathConstants::TWOPI / 60) * DRIVING_RATED_MOTOR_SPEED / DRIVING_GEAR_RATIO) * WHEEL_RADIUS;       // [m/s]
