...
namespace RobotConstants
{
    ...
    constexpr double AXLE_LENGTH                 = 0.53;  //0.33;             // [m]
    constexpr double ROBOT_WIDTH                 = 0.96;             // [m] ///////////////CHANGE
    // constexpr double ROBOT_LENGTH                = 1.30;             // [m]
    constexpr double WHEEL_RADIUS                = 0.328 / 2;  //0.055;           // [m]
    ...
    constexpr double MAX_WHEEL_ACC               = 0.1;          // [m/s^2]
    constexpr double MAX_WHEEL_VEL               = 2.0;       // [m/s]
...
namespace ControlConstants
{
    ...
    constexpr double PURE_PURSUIT_LOOKAHEAD = 0.5;
...
{
    constexpr double PATH_VEL_LIM  = 0.2;
