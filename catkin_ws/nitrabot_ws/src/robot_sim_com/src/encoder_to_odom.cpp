...
private:
	...
	new_y = RobotModel::calc_x(y_, x_dot_, new_y_dot, timestamp_);
...
public:
    ...
    {
	nh_ = nh;
	odometry_ = nh_.advertise<nav_msgs::Odometry>("odom", 50);
    ...
    void getEncoderData(const industrial_robot_qt::EncoderWheelVel::ConstPtr &enc)
    {
