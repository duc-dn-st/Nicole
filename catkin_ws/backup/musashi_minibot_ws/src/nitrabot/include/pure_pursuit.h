...
#define POS_THRESHOLD2 1.0
#define HEADING_THRESHOLD2 30 * MathConstants::PI / 180

#define POS_THRESHOLD3 0.1
#define HEADING_THRESHOLD3 30 * MathConstants::PI / 180
...
private:
    ...
    bool nearGoal(const Eigen::Vector3d &error) const;
    bool nearGoal2(const Eigen::Vector3d &error) const;
